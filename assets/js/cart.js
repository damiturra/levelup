...
(function() {
    ...
    function addToCart(code, quantity = 1) {
        ...
        if (existingItem) {
            ...
            // Determine correct image extension based on product code
            let imageExt = 'webp'; // default extension
            if (product.code === 'JM001') imageExt = 'jpeg';
            if (product.code === 'JM002') imageExt = 'jpg';
            if (product.code === 'CG001') imageExt = 'png';
            ...
            cart.push({
                ...
                price: product.price,
                quantity: quantity,
                image: `assets/images/${product.code}.${imageExt}`
            });
        }
